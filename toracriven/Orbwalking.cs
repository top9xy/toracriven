...
namespace toracriven
{
    public static class Orbwalking
    {
            ...
            bool randomizeMinDistance = true)
        {
            ...
            if (playerPosition.Distance(position) < holdAreaRadius * holdAreaRadius)
            {
        ...
        private static void AIBaseClient_OnDoCast(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs args)
        {
            if (sender.IsMe)
            {
                ...
                {
                    Utility.DelayAction.Add(30, () => AIBaseClient_OnDoCast_Delayed(sender, args));
                    return;
                }
        ...
        public class Orbwalker
        {
            ...
            /// The orbalker mode
            /// </summary>
            private OrbwalkerMode _mode = OrbwalkerMode.None;
